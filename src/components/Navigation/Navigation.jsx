  ...
  return (
    <nav className='flex items-center py-6 px-16 justify-between gap-20 custom-nav'>
      <div className='flex items-center gap-6'>
        {/* Logo */}
        <a className='text-3xl text-black font-bold gap-8' href='/'>BOOK STORE</a>
      </div>
      { variant ==="default" &&
      <div className='flex flex-wrap items-center gap-10'>
        ...
        <ul className='flex gap-14 text-gray-600 hover:text-black'>
          ...
          <li><NavLink to='/books' className={({isActive})=> isActive ? 'active-link':''}>SẢN PHẨM</NavLink></li>
        </ul>
      ...
      <div className='flex flex-wrap items-center gap-4'>
        ...
        <ul className='flex gap-8 '>
          ...
          <li><Link to='/cart' className='flex flex-wrap'><CartIcon />
